...
var main = function (input) {
  ...
  if (gameMode == DISPLAY_WINNER) {
    ...
    gameMode = RESTART;
    instructionsText.innerHTML = myOutputValue;
    button.removeAttribute("disabled");
    hitButton.setAttribute("disabled", "disabled");
    standButton.setAttribute("disabled", "disabled");
    return `<br> Press Submit to play again!`;
  }
  ...
  if ((gameMode = RESTART)) {
    ...
    console.log("restart");
    document.getElementById("#instructions").innerText = "Enter bet to restart";
    return `Please enter bet to restart`;
  }
};
